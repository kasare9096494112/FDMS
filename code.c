...
typedef struct deptdata
{ // used to keep track of record of average salary per department
...
int main()
{
    ...
    while (1)
    {
        ...
        case 7:
            ...
            {
            case 1:
                strcpy(em.department, "CSE");
                break;
            case 2:
                strcpy(em.department, "Mechanical");
                break;
            case 3:
                strcpy(em.department, "IT");
                break;
            case 4:
                strcpy(em.department, "Civil");
                break;
            case 5:
                strcpy(em.department, "Electrical");
                break;
            case 6:
                strcpy(em.department, "Electronics");
                break;
            }
